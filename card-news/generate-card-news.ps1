...
$EXAMPLES = @(
  ...
  @{ before = "몇 번을 말해야 알아들어?"; after = "제가 다시 한 번 명확하게 설명드릴게요." },
...
$g.DrawString("잔소리 순화기 · 무료 · 회원가입 없음", $footerFont, (New-Object System.Drawing.SolidBrush($accent)), 100, ($footerY + 18))
...
<body>
  <div class="wrap">
    ...
    <a class="back" href="/">← 잔소리 순화기로 가기</a>
  </div>
<script>
